...
/**
 * Brazilian "State Registration" Algorithm for State "PI" (Piauí)
 *
...
class PI {
    ...
    /**
     * Validates given "State Registration" against "Piauí" Algorithm
     *
     * @param string|integer $number
     *  Given "State Registration" to be validated
     *
     * @return bool
     *  TRUE if given "State Registration" is valid according to "Piauí" Algorithm
     *  and FALSE otherwise
     */
