...
/**
 * Brazilian "State Registration" Algorithm for State "SC" (Santa Catarina)
 *
...
class SC {
    ...
    /**
     * Validates given "State Registration" against "Santa Catarina" Algorithm
     *
     ...
     * "Santa Catarina" Algorithm and FALSE otherwise
     */
