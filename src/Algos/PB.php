...
/**
 * Brazilian "State Registration" Algorithm for State "PB" (Paraíba)
 *
...
class PB {
    ...
    /**
     * Validates given "State Registration" against "Paraíba" Algorithm
     *
     * @param string|integer $number
     *  Given "State Registration" to be validated
     *
     * @return bool
     *  TRUE if given "State Registration" is valid according to "Paraíba" Algorithm
     *  and FALSE otherwise
     */
