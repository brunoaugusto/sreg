...
/**
 * Brazilian "State Registration" Algorithm for State "CE" (Ceará)
 *
...
class CE {
    ...
    /**
     * Validates given "State Registration" against "Ceará" Algorithm
     *
     * @param string|integer $number
     *  Given "State Registration" to be validated
     *
     * @return bool
     *  TRUE if given "State Registration" is valid according to "Ceará" Algorithm
     *  and FALSE otherwise
     */
